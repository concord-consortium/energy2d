...
public class Helper {
	...
	public final static void showAbout(Frame frame) {
		...
		s += "http://energy.concord.org/energy2d<br>The Advanced Educational Modeling Laboratory, The Concord Consortium, 2011-2013";
		s += "<hr>";
		s += "<h4>Attribution & Acknowledgement:</h4>This program is created by Dr. Charles Xie. Funding is provided by the National Science Foundation<br>under grants #0918449 and #1124281, for which Dr. Xie also serves as the Principal Investigator.";
