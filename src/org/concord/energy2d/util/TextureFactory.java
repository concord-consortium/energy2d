...
public final class TextureFactory {
	...
	final static byte[] STYLE_ARRAY = new byte[] { 
			POLKA, POLKA, MOSIAC, MOSIAC, POSITIVE, NEGATIVE, 
			STARRY, CIRCULAR, HORIZONTAL_STRIPE, HORIZONTAL_STRIPE, VERTICAL_STRIPE, VERTICAL_STRIPE, 
			DIAGONAL_UP_STRIPE, DIAGONAL_UP_STRIPE, DIAGONAL_DOWN_STRIPE, DIAGONAL_DOWN_STRIPE, GRID, GRID, 
			HORIZONTAL_BRICK, HORIZONTAL_BRICK, DENSITY50, DENSITY25, DENSITY5, DENSITY95, 
			DENSITY5, DENSITY95, CIRCLE_CONTACT, CIRCLE_CONTACT, CIRCLE_SEPARATE, CIRCLE_SEPARATE, 
			HORIZONTAL_LATTICE, HORIZONTAL_LATTICE, HORIZONTAL_LATTICE, DICE, DICE, TRIANGLE_HALF };

	final static byte[] SIZE_ARRAY = new byte[] { 
			SMALL, MEDIUM, SMALL, MEDIUM, MEDIUM, MEDIUM, 
			LARGE, LARGE, SMALL, MEDIUM, SMALL, MEDIUM,
			MEDIUM, LARGE, MEDIUM, LARGE, SMALL, MEDIUM, 
			MEDIUM, LARGE, SMALL, SMALL, SMALL, SMALL, 
			LARGE, LARGE, MEDIUM, LARGE, MEDIUM, LARGE, 
